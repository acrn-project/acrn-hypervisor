...
#define VM0_CONFIG_CPU_AFFINITY	(AFFINITY_CPU(2U)) // (AFFINITY_CPU(0U) | AFFINITY_CPU(2U))
#define VM1_CONFIG_CPU_AFFINITY	(AFFINITY_CPU(3U)) // (AFFINITY_CPU(1U) | AFFINITY_CPU(3U))
