...
#define HC_TEE_BOOT_DONE            BASE_HC_ID(HC_ID, HC_ID_TEE_BASE + 0x00UL)
#define HC_NOTIFY_TEE		    BASE_HC_ID(HC_ID, HC_ID_TEE_BASE + 0x01UL)
#define HC_NOTIFY_REE		    BASE_HC_ID(HC_ID, HC_ID_TEE_BASE + 0x02UL)
#define HC_GET_TEE_CORE_NUM	    BASE_HC_ID(HC_ID, HC_ID_TEE_BASE + 0x03UL)
